# =============================================================================
# e03.jl — Tensor-spline shape-constrained regression (dense-QP habitat)
#
# Usage:
#   julia --project e03.jl              # Clarabel only
#   julia --project e03.jl --mosek      # + Mosek
#   julia --project e03.jl --quick      # small sweep
# =============================================================================
