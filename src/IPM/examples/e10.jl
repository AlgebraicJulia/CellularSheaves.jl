# =============================================================================
# e10.jl — Compositional Lyapunov certification on a K×K torus of subsystems
#          (Agler-split dense SDP with Gramian-weighted dense Q)
#
# Usage:
#   julia --project e10.jl              # Clarabel baseline
#   julia --project e10.jl --mosek      # + Mosek
#   julia --project e10.jl --quick      # quick (smaller) sweep
#
