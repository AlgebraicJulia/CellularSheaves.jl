# =============================================================================
# e14.jl — Gyre-aware robust flow recovery on a punctured grid
#          (full-Hodge design: dense-map + dense-Q + SOC, harmonic stalk)
#
# Usage:
#   julia --project e14.jl              # Clarabel baseline
#   julia --project e14.jl --mosek      # + Mosek (benchmarked primal)
#   julia --project e14.jl --quick      # quick (smaller) sweep
#
