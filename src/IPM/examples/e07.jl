# =============================================================================
# e07.jl — Poisson-TV: photon-limited deconvolution (exponential-cone habitat)
#
# Usage:
#   julia --project e07.jl              # Clarabel only
#   julia --project e07.jl --mosek      # + Mosek
#   julia --project e07.jl --quick      # small sweep
#
